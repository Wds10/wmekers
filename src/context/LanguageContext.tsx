...
const translations: Translations = {
    es: {
        ...
        home: {
            ...
            hero_desc: 'Descargá GRATIS miles de modelos. Comprá archivos STL premium a precios accesibles. Imprimí en 3D hoy mismo.',
            btn_explore: 'Explorá Descargas GRATIS',
            btn_creator: 'Comprá STL Baratos',
            ...
            feat_secure_desc: 'Plataforma protegida con pagos encriptados (Mercado Pago Argentina).',
